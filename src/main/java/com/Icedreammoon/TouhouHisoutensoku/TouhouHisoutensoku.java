...
@Mod(TouhouHisoutensoku.MOD_ID)
public class TouhouHisoutensoku
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "ttz";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public TouhouHisoutensoku(FMLJavaModLoadingContext context)
    {
